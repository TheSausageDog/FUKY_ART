...
/// <summary>
/// Helper script to create a Pepper Particle Generator prefab in the Unity Editor.
/// This script is meant to be used in the Editor only.
/// </summary>
public class CubeParticleGeneratorPrefabSetup : MonoBehaviour
{
#if UNITY_EDITOR
    [MenuItem("Assets/Create/Particle System/Pepper Particle Generator Prefab")]
    public static void CreateCubeParticleGeneratorPrefab()
    {
        ...
        Object.DestroyImmediate(particleGenerator);
    ...
    [MenuItem("GameObject/Effects/Pepper Particle Generator")]
    public static void CreateCubeParticleGeneratorInScene()
    {
        // Create an empty GameObject
        GameObject particleGenerator = new GameObject("PepperParticleGenerator");
        ...
        Debug.Log("Pepper Particle Generator created in scene. It will generate pepper-like particles from a plane area.");
    }
